...
terminal tools. Where [autoreview](../autoreview/) is a defensive gate on your own diff,
...
It also plugs into the existing [autoreview](../autoreview/) (the fix gate) and `verify`
...
For reviewing your own session diff for quality, use [autoreview](../autoreview/) instead.
