...
| [Bughunt](bughunt/) | 2026-06-06.2 | Offensive whole-codebase bug hunter for any project type. Recon → parallel fan-out across 9 analysis lenses × risk hotspots → merge, cross-validate, report ranked reproducible findings. Report-only. Invoke with `/bughunt`. |
